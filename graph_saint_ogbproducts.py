...
def main():
    ...
    if args.sampling_method != 'baseline':
        data.x = attach_deterministic_distance_embedding(data=data, num_anchor_nodes=args.num_anchor_nodes, sampling_method=args.sampling_method)
    ...
    wandb.init(name=f'{args.sampling_method}-{args.num_anchor_nodes}',project='GraphPOPE-saint-ogbnproducts')
    config = wandb.config
